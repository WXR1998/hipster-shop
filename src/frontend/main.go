...
func main() {
	...
	r.HandleFunc("/product_test/{id}", svc.homeHandler).Methods(http.MethodGet, http.MethodHead)
	r.HandleFunc("/cart_test", svc.homeHandler).Methods(http.MethodGet, http.MethodHead)
	r.HandleFunc("/cart_test", svc.homeHandler).Methods(http.MethodPost)
	r.HandleFunc("/cart/empty", svc.emptyCartHandler).Methods(http.MethodPost)
	r.HandleFunc("/setCurrency_test", svc.setCurrencyHandler).Methods(http.MethodPost)
